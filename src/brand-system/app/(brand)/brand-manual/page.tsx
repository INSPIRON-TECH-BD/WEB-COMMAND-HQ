            ...
            <section id="geometry">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start mt-12">
                    ...
                    <div className="bg-[#0b0e14] p-16 rounded-[32px] border border-[#30363d] shadow-2xl group flex items-center justify-center">
                        <RefinedLogo className="w-full h-auto drop-shadow-[0_0_40px_rgba(0,255,255,0.15)] group-hover:drop-shadow-[0_0_60px_rgba(0,255,255,0.25)] transition-all duration-500" />
                    </div>
                </div>
            </section>
