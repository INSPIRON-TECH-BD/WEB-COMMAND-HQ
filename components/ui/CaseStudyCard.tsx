...
export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({
    ...
    return (
        <div className="p-10 bg-white/[0.03] border border-white/10 rounded-[32px] hover:border-aqua/50 transition-all group flex flex-col h-full">
            <div className="mb-8">
            ...
            <div className="mt-auto">
                ...
                {link && (
                    <Link href={link} className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white group-hover:text-aqua transition-colors">
